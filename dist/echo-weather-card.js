...
var wt = (r, t, e) => t in r ? At(r, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : r[t] = e;
var k = (r, t, e) => wt(r, typeof t != "symbol" ? t + "" : t, e);
/**
 * @license
...
const Et = (r) => new ft(typeof r == "string" ? r : r + "", void 0, G), St = (r, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Ct, defineProperty: Ot, getOwnPropertyDescriptor: zt, getOwnPropertyNames: Pt, getOwnPropertySymbols: Ut, getPrototypeOf: Tt } = Object, y = globalThis, Q = y.trustedTypes, Rt = Q ? Q.emptyScript : "", D = y.reactiveElementPolyfillSupport, x = (r, t) => r, V = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? Rt : null;
      break;
  ...
  return e;
} }, $t = (r, t) => !Ct(r, t), X = { attribute: !0, type: String, converter: V, reflect: !1, useDefault: !1, hasChanged: $t };
var ct, lt;
(ct = Symbol.metadata) != null || (Symbol.metadata = Symbol("metadata")), (lt = y.litPropertyMetadata) != null || (y.litPropertyMetadata = /* @__PURE__ */ new WeakMap());
let A = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t, e, s) {
    var o;
    const { get: i, set: n } = (o = zt(this.prototype, t)) != null ? o : { get() {
      return this[e];
    }, set(h) {
      this[e] = h;
    } };
    return { get: i, set(h) {
      ...
      n == null || n.call(this, h), this.requestUpdate(t, a, s);
  ...
  _$AK(t, e) {
    ...
    if (i !== void 0 && this._$Em !== i) {
      ...
      this[i] = (h = l != null ? l : (o = this._$Ej) == null ? void 0 : o.get(i)) != null ? h : l, this._$Em = null;
    }
  }
  requestUpdate(t, e, s, i = !1, n) {
    ...
    if (t !== void 0) {
      ...
      if (i === !1 && (n = this[t]), s != null || (s = a.getPropertyOptions(t)), !(((o = s.hasChanged) != null ? o : $t)(n, e) || s.useDefault && s.reflect && n === ((h = this._$Ej) == null ? void 0 : h.get(t)) && !this.hasAttribute(a._$Eu(t, s)))) return;
      this.C(t, e, s);
    }
  ...
  C(t, e, { useDefault: s, reflect: i, wrapped: n }, o) {
    var h, a, c;
    s && !((h = this._$Ej) != null ? h : this._$Ej = /* @__PURE__ */ new Map()).has(t) && (this._$Ej.set(t, (a = o != null ? o : e) != null ? a : this[t]), n !== !0 || o !== void 0) || (this._$AL.has(t) || (this.hasUpdated || s || (e = void 0), this._$AL.set(t, e)), i === !0 && this._$Em !== t && ((c = this._$Eq) != null ? c : this._$Eq = /* @__PURE__ */ new Set()).add(t));
  }
  async _$EP() {
...
var dt;
A.elementStyles = [], A.shadowRootOptions = { mode: "open" }, A[x("elementProperties")] = /* @__PURE__ */ new Map(), A[x("finalized")] = /* @__PURE__ */ new Map(), D == null || D({ ReactiveElement: A }), ((dt = y.reactiveElementVersions) != null ? dt : y.reactiveElementVersions = []).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const C = globalThis, tt = (r) => r, M = C.trustedTypes, et = M ? M.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, yt = "$lit$", $ = `lit$${Math.random().toFixed(9).slice(2)}$`, mt = "?" + $, Ht = `<${mt}>`, b = document, z = () => b.createComment(""), P = (r) => r === null || typeof r != "object" && typeof r != "function", J = Array.isArray, Mt = (r) => J(r) || typeof (r == null ? void 0 : r[Symbol.iterator]) == "function", L = `[ 	
\f\r]`, S = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, st = /-->/g, it = />/g, m = RegExp(`>|${L}(?:([^\\s"'>=/]+)(${L}*=${L}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), rt = /'/g, nt = /"/g, gt = /^(?:script|style|textarea|title)$/i, Nt = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), p = Nt(1), w = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), ot = /* @__PURE__ */ new WeakMap(), g = b.createTreeWalker(b, 129);
function vt(r, t) {
...
const kt = (r, t) => {
  ...
  for (let h = 0; h < e; h++) {
    const a = r[h];
    let c, l, u = -1, _ = 0;
    for (; _ < a.length && (o.lastIndex = _, l = o.exec(a), l !== null); ) _ = o.lastIndex, o === S ? l[1] === "!--" ? o = st : l[1] !== void 0 ? o = it : l[2] !== void 0 ? (gt.test(l[2]) && (i = RegExp("</" + l[2], "g")), o = m) : l[3] !== void 0 && (o = m) : o === m ? l[0] === ">" ? (o = i != null ? i : S, u = -1) : l[1] === void 0 ? u = -2 : (u = o.lastIndex - l[2].length, c = l[1], o = l[3] === void 0 ? m : l[3] === '"' ? nt : rt) : o === nt || o === rt ? o = m : o === st || o === it ? o = S : (o = m, i = void 0);
    const f = o === m && r[h + 1].startsWith("/>") ? " " : "";
    n += o === S ? a + Ht : u >= 0 ? (s.push(c), a.slice(0, u) + yt + a.slice(u) + $ + f) : a + $ + (u === -2 ? h : f);
  }
...
class U {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    this.parts = [];
    let n = 0, o = 0;
    const h = t.length - 1, a = this.parts, [c, l] = kt(t, e);
    ...
    for (; (i = g.nextNode()) !== null && a.length < h; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const u of i.getAttributeNames()) if (u.endsWith(yt)) {
          const _ = l[o++], f = i.getAttribute(u).split($), R = /([.?@])?(.*)/.exec(_);
          a.push({ type: 1, index: n, name: R[2], strings: f, ctor: R[1] === "." ? Lt : R[1] === "?" ? jt : R[1] === "@" ? Ft : N }), i.removeAttribute(u);
        } else u.startsWith($) && (a.push({ type: 6, index: n }), i.removeAttribute(u));
        if (gt.test(i.tagName)) {
          const u = i.textContent.split($), _ = u.length - 1;
          if (_ > 0) {
            i.textContent = M ? M.emptyScript : "";
            for (let f = 0; f < _; f++) i.append(u[f], z()), g.nextNode(), a.push({ type: 2, index: ++n });
            i.append(u[_], z());
          }
        }
        ...
        let u = -1;
        for (; (u = i.data.indexOf($, u + 1)) !== -1; ) a.push({ type: 7, index: n }), u += $.length - 1;
      }
      n++;
    }
  }
...
function E(r, t, e = r, s) {
  ...
  return (i == null ? void 0 : i.constructor) !== n && ((h = i == null ? void 0 : i._$AO) == null || h.call(i, !1), n === void 0 ? i = void 0 : (i = new n(r), i._$AT(r, e, s)), s !== void 0 ? ((a = e._$Co) != null ? a : e._$Co = [])[s] = i : e._$Cl = i), i !== void 0 && (t = E(r, i._$AS(r, t.values), i, s)), t;
}
class Dt {
  constructor(t, e) {
  ...
  u(t) {
    ...
    for (; a !== void 0; ) {
      if (o === a.index) {
        let l;
        a.type === 2 ? l = new T(n, n.nextSibling, this, t) : a.type === 1 ? l = new a.ctor(n, a.name, a.strings, this, t) : a.type === 6 && (l = new It(n, this, t)), this._$AV.push(l), a = s[++h];
      }
...
class T {
  ...
  _$AI(t, e = this) {
    t = E(this, t, e), P(t) ? t === d || t == null || t === "" ? (this._$AH !== d && this._$AR(), this._$AH = d) : t !== this._$AH && t !== w && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Mt(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  k(t) {
    ...
    const e = this._$AH;
    let s, i = 0;
    for (const n of t) i === e.length ? e.push(s = new T(this.O(z()), this.O(z()), this, this.options)) : s = e[i], s._$AI(n), i++;
...
class N {
  ...
  _$AI(t, e = this, s, i) {
    ...
    if (n === void 0) t = E(this, t, e, 0), o = !P(t) || t !== this._$AH && t !== w, o && (this._$AH = t);
      ...
      const h = t;
      let a, c;
      for (t = n[0], a = 0; a < n.length - 1; a++) c = E(this, h[s + a], e, a), c === w && (c = this._$AH[a]), o || (o = !P(c) || c !== this._$AH[a]), c === d ? t = d : t !== d && (t += (c != null ? c : "") + n[a + 1]), this._$AH[a] = c;
    }
    o && !i && this.j(t);
  }
  j(t) {
...
class Ft extends N {
  ...
  _$AI(t, e = this) {
    var o;
    if ((t = (o = E(this, t, e, 0)) != null ? o : d) === w) return;
...
const Bt = (r, t, e) => {
  ...
  if (i === void 0) {
    ...
    s._$litPart$ = i = new T(t.insertBefore(z(), h), h, void 0, e != null ? e : {});
  }
  return i._$AI(r), i;
};
/**
...
var pt;
O._$litElement$ = !0, O.finalized = !0, (pt = v.litElementHydrateSupport) == null || pt.call(v, { LitElement: O });
const F = v.litElementPolyfillSupport;
F == null || F({ LitElement: O });
var _t;
((_t = v.litElementVersions) != null ? _t : v.litElementVersions = []).push("4.2.2");
const bt = "echo-weather-card", Wt = "https://cdn.jsdelivr.net/npm/@meteocons/svg/fill", Vt = 1, qt = 2, at = {
  hourly_count: 6,
  daily_count: 4,
  language: null,
  time_format: null,
...
function Yt(r, t, e) {
  ...
  const i = [];
  if (ht(s, Vt) && i.push("daily"), ht(s, qt) && i.push("hourly"), i.length === 0)
    return console.warn(
  ...
  return i.forEach((h) => {
    r.connection.subscribeMessage(
      (a) => e(h, a.forecast || []),
      { type: "weather/subscribe_forecast", forecast_type: h, entity_id: t }
    ).then((a) => {
      o ? a() : n.push(a);
    }).catch(async (a) => {
      console.warn(
        `[echo-weather-card] souscription forecast "${h}" indisponible, repli sur get_forecasts`,
        a
      );
      const c = await Kt(r, t, h);
      o || e(h, c);
    });
  }), () => {
    o = !0, n.forEach((h) => h());
...
class q extends O {
  ...
  _renderCurrent(t) {
    const e = I(t.state, this._isNight()), s = B(e, this._config.icons), i = W(this._hass, t.state), n = t.attributes.temperature, o = t.attributes.apparent_temperature;
    return p`
      <div class="current">
  ...
  _renderHourly(t, e) {
    ...
    return i.length ? p`
      <div class="hourly">
        ${i.map((n) => {
      const o = new Date(n.datetime), h = I(
        n.condition,
        this._isNight(o)
      ), a = B(h, this._config.icons), c = W(this._hass, n.condition), l = n.precipitation_probability;
      return p`
            <div class="hourly-item">
              ...
              ${this._config.show_precipitation_probability && l > 0 ? p`<div class="hourly-pop">${l}%</div>` : d}
            </div>
          `;
    })}
      </div>
  ...
  _renderDaily(t) {
    ...
    return e.length ? p`
      <div class="daily">
        ${e.map((s) => {
      const i = new Date(s.datetime), n = I(s.condition, !1), o = B(n, this._config.icons), h = W(this._hass, s.condition);
      return p`
            <div class="daily-item">
              <div class="daily-day">${Jt(i, t)}</div>
              <img class="daily-icon" src=${o} alt=${h} />
